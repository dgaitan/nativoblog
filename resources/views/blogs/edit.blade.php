    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-md-8">
                <h1 class="mb-3 mt-3">Editing: {{ $post->title }}</h1>
                <form action="{{ $post->getUpdateActionLink() }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-md-6">
                            <textarea id="content" class="form-control{{ $errors->has('content') ? ' is-invalid' : '' }}" name="content" rows="10" required>{{ $post->content }}</textarea>
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="{{ $post->getDetailLink() }}" class="btn btn-dark">Back</a>
